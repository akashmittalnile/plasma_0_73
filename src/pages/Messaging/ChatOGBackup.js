    ...
    <LinearGradient colors={['#300076', '#53045F']} style={{ flex: 1 }}>
      ...
      <View style={{
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View>
            <Text style={{fontFamily:FONTFAMILY, color: '#fff', fontWeight: 'bold', fontSize: 11 }}>Good Morning</Text>
            <Text style={{fontFamily:FONTFAMILY, color: '#DF81EF', fontWeight: 'bold', marginTop: 3, fontSize: 15 }}>Ashish</Text>
          </View>
        </View>
        <View style={{ flexDirection: 'row' }}>
