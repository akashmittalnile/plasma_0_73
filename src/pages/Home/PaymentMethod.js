                ...
                <>
                  <TouchableOpacity
                    ...
                    <View style={{flexDirection:'row'}}>
                        <TouchableOpacity style={{height:30,width:30,borderRadius:20,borderWidth:1,borderColor:'#B357C3',justifyContent: 'center',marginRight:10}}>
                            <View style={{width:20,height:20,borderRadius:15,backgroundColor:'#B357C3',alignSelf:'center'}} />
                        </TouchableOpacity>
                      <Image
                        source={item.img}
                        style={{
...
<Text style={{fontFamily:FONTFAMILY,fontSize:10,color:"#fff",textAlign:"center",fontWeight:"600"}}>CONFIRM</Text>
</TouchableOpacity>
            ...
            <View
              ...
              <KeyboardAwareScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.mainView}>
                 ...
                 <Text style={{fontFamily:FONTFAMILY,textAlign:'center',marginTop:8,color:'#000',fontWeight:'400',fontSize:11,lineHeight:18}}>Thank you for purchasing course . We received your order and Successfully placed. Kindly check the course in My Courses section.</Text>
