...
export default function MyNetinfo() {
 const dispatch =  useDispatch();
    ...
    return (
        ...
        <Text style={{fontFamily:FONTFAMILY,color:Mycolors.GrayColor,fontWeight:'bold',fontSize:18, fontFamily:FONTFAMILY}}>You are offline!</Text>
        <Text style={{fontFamily:FONTFAMILY,fontSize:12,color:Mycolors.GrayColor,top:6}}>Go online to start accepting jobs.</Text>
        </View> 
        </View>
